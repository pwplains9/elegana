export const config = {
    ...
    server: { // настройки для dev-сервера
        ...
        tunnel: "ninelines", // нужен ли онлайн путь до локальной сборки (пока не работает)
    },
    images: { // настройки для оптимизации изображений
        components: {
            /**
